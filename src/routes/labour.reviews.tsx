...
export const Route = createFileRoute("/labour/reviews")({
  head: () => ({ meta: [{ title: "Reviews — FarmFleet" }] }),
  component: LabourReviews,
});
...
// ─── Stat Card — identical to Owner Reviews.tsx ───────────────────────────────
    ...
    >
      ...
      <div className="flex items-center gap-2 mb-5">
        ...
        <div>
          ...
          <p className="text-[11px] text-muted-foreground">Monthly farmer reviews received</p>
        </div>
      </div>
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            {review.workType && (
              <p className="text-[11px] text-muted-foreground truncate">{review.workType}</p>
            )}
          </div>
        </div>
...
function LabourReviews() {
  ...
  const fetchReviews = useCallback(async () => {
    ...
    setError("");
    try {
      const { data } = await axios.get<ReviewsResponse>(API, {
        headers: authHeaders(),
      });
      setReviewsData(data);
    } catch {
  ...
  // Satisfaction sentiment breakdown derived from farmerSatisfaction
  const sentimentRows = useMemo(() => {
    const score = reviewsData?.farmerSatisfaction ?? 0;
    const total = reviewsData?.totalReviews ?? 0;
        ...
        >
          <div>
            ...
            <p className="mt-1.5 text-sm text-muted-foreground max-w-md">
              Monitor farmer feedback, ratings and work quality across all completed jobs.
            </p>
          </div>
          <motion.div
          ...
          >
            ...
            <span className="text-sm font-semibold text-amber-400">⭐ Top Rated Farm Labour</span>
          </motion.div>
        </motion.div>
            ...
            {loading ? (
              ...
              <>
                ...
                <StatCard
                  ...
                  value={reviewsData?.farmerSatisfaction ?? 0}
                  accent="#a855f7"
                  delay={0.15}
                  suffix="%"
                />
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center gap-8">
                <div className="flex-shrink-0 flex flex-col items-center">
                  <SatisfactionRing score={reviewsData.farmerSatisfaction ?? 0} />
                ...
                <div className="flex-1 w-full space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2 pt-2">
                    {[
                      { label: "Top Rated Labour", color: "#22c55e" },
              ...
              <AnimatePresence mode="wait">
                {filteredReviews.length === 0 ? (
                  ...
                  >
                    ...
                    <p className="text-sm text-muted-foreground max-w-xs">
                      Complete labour requests to start receiving reviews from farmers.
                    </p>
                  </motion.div>
                ) : (
                  <motion.div
