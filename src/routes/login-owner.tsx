...
export default function OwnerAuthPage() {
  ...
  const handleSignIn = () => nav({ to: "/owner/dashboard" });
  const handleSignUp = () => nav({ to: "/owner/dashboard" });
          ...
          <div>
            ...
            >
              ...
              <svg
                ...
                className="h-16 w-20 mb-6 opacity-90"
                aria-hidden="true"
              >
                <rect x="2" y="18" width="44" height="24" rx="4" fill="white" fillOpacity="0.25" />
                <rect x="10" y="10" width="24" height="16" rx="3" fill="white" fillOpacity="0.35" />
                <circle cx="18" cy="42" r="10" stroke="white" strokeOpacity="0.8" strokeWidth="3" fill="none" />
                <circle cx="18" cy="42" r="4" fill="white" fillOpacity="0.5" />
                <circle cx="56" cy="44" r="8" stroke="white" strokeOpacity="0.8" strokeWidth="3" fill="none" />
                <circle cx="56" cy="44" r="3" fill="white" fillOpacity="0.5" />
                <rect x="44" y="26" width="18" height="14" rx="3" fill="white" fillOpacity="0.2" />
                <rect x="46" y="22" width="10" height="8" rx="2" fill="white" fillOpacity="0.3" />
              </svg>
            </motion.div>
            ...
            >
              List Your Equipment. Grow Your Income.
            </motion.h2>
            ...
            >
              Connect with farmers across your region and earn more by renting out your agricultural equipment through FarmFleet.
            </motion.p>
            ...
            >
              {["Verified Farmers", "Secure Payments", "Easy Equipment Management"].map((feat) => (
                <span
                  key={feat}
        ...
        <div className="flex-1 flex items-start justify-center px-6 sm:px-10 py-8">
          ...
          >
            ...
            <p className="mt-2 text-muted-foreground leading-relaxed">
              Manage your equipment, track rentals, and grow your income.
            </p>
            ...
            <div className="mt-6 pt-5 border-t border-border flex items-center justify-center gap-2 sm:gap-3 text-xs text-muted-foreground flex-wrap">
              <span>Farmer / Renter? <Link to="/login-renter" className="font-semibold text-foreground hover:text-primary transition-colors">Farmer Login →</Link></span>
              <span>•</span>
